...
public class Zhiweib implements Serializable {
    ...
    public Integer getSfyiwurenyuan() {
        return sfyiwurenyuan;
    }

    public void setSfyiwurenyuan(Integer sfyiwurenyuan) {
        this.sfyiwurenyuan = sfyiwurenyuan;
    }
