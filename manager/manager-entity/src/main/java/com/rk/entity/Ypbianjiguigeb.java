...
public class Ypbianjiguigeb implements Serializable {
    private Integer ybbianjiid;
    ...
    public Integer getYbbianjiid() {
        return ybbianjiid;
    }

    public void setYbbianjiid(Integer ybbianjiid) {
        this.ybbianjiid = ybbianjiid;
    }
