...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../backstage/css/common.css" media="all">
	<link rel="stylesheet" type="text/css" href="../backstage/css/main.css" media="all">
</head>
<body>
                            ...
                            <li>
                                ...
                                <fieldset class="layui-elem-field content">
                                    ...
                                    <div class="layui-field-box">
                                      <p>如：datatable、json数据表格分页、基于flex的grid布局、通用菜单按钮级权限模块等模块功能这些会在后续更新中相继推出（当然有一些后台最常用的功能在layui官方2.0中可能会出现，同时十分期待2.0，有时候不需要重复造轮子，在后期更新中选择性更新，目前只是一个cms后台通用模版，有瑕疵和改进的地方希望大家帮忙多提建议！待LarryCMS整体完成后分享基于ThinkPHP+layim聊天功能的cms系统）</p>
                                    </div>
                                </fieldset>
                            ...
                            <tr>
                              <td class="top-top">
                                <p class="larry_github">
                                  ...
                                  <br>
github地址：<a href="https://github.com/larryqin/larrycms" class="githublink" target="_blank">https://github.com/larryqin/larrycms</a> (系统整体完成后再上传github)<br>
layui后台交流群：<span>493153642</span><a href="https://jq.qq.com/?_wv=1027&k=42fC4vT"><img border="0" src="../images/group.png" title="LarryCMS官方交流群"></a>
                                </p>
                              </td>
                            </tr>
                    </table>
