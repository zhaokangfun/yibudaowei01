...
<body class="static-public-css storage-manage-css main-data-manage inbound-css">
                        ...
                        <table class="common-table full-width-table" id="projecttable">
                            ...
                            <tr id="lastTr">
                                <td colspan="5" width="34%">
                                    <div class="drop">
                                        <input class="input-text input-text-ware" placeholder="编号/名称/条码/五笔码/拼音码" name="" id="add-coloum" autocomplete="off" type="text">
                                    </div>
                                </td>
                                <td></td>
                                <td></td>
	...
	<div id="add_edit_div" class="content-inner" style="display: none">
		<div class="tab-content clear trade">
			<div class="bl-title">
				<h2>新增厂商</h2>
			</div>
			<table class="input-table" style="margin-top: 40px">
				<tbody><tr>
					<td style="display: none"><input class="input-text" id="vendorId" type="text"></td>
					<td style="display: none"><input class="input-text" id="pVendorId" type="text"></td>
					<td><span class="form-item-title"><i class="necessary">*</i>厂商编码：</span>
						<input class="input-text validate(required, digits, maxlength(8))" id="vendorCode" type="text"></td>
					<td><span class="form-item-title"><i class="necessary">*</i>厂商名称：</span>
						<input class="input-text validate(required, maxlength(25))" id="vendorName" onkeyup="keyup()" type="text"></td>
					<td><span class="form-item-title"><i class="necessary">*</i>厂商简称：</span>
						<input class="input-text validate(required, maxlength(6))" id="vendorShort" type="text"></td>
				</tr>
				<tr>
					<td><span class="form-item-title"><i class="necessary">*</i>厂商类型：</span>
						<input class="input-text validate(required)" readonly="readonly" id="vendorType" type="text"></td>
					<td><span class="form-item-title"><i class="necessary">*</i>产品类型：</span>

						<div class="drop">
							<input class="input-text validate(required)" readonly="readonly" id="productType" type="text"> <i class="drop-icon"></i>
							<ul class="drop-menu dsn" id="productTypeList" style="display: none;">
							</ul>
						</div></td>
					<td><span class="form-item-title">营业执照号：</span> <input class="input-text validate(maxlength(15))" id="vendorLicense" type="text"></td>
				</tr>
				<tr>
					<td><span class="form-item-title">五笔简码：</span> <input class="input-text" id="wbCode" type="text"></td>
					<td><span class="form-item-title">拼音简码：</span> <input class="input-text" id="pyCode" type="text"></td>
				</tr>
			</tbody></table>
			<div class="address">
				<div class="fl">厂商地址：</div>
				<div class="drop fl">
					<input class="input-text" readonly="readonly" placeholder="国家" id="nation" type="text"> <i class="drop-icon"></i>
					<ul class="drop-menu dsn" id="nationList" style="display: none;">
					</ul>
				</div>
				<div class="drop fl">
					<input class="input-text" readonly="readonly" placeholder="省份" id="province" type="text"> <i class="drop-icon"></i>
					<ul class="drop-menu dsn" id="provinceList" style="display: none;">
					</ul>
				</div>
				<div class="drop fl">
					<input class="input-text" readonly="readonly" placeholder="市" id="city" type="text"> <i class="drop-icon"></i>
					<ul class="drop-menu dsn" id="cityList" style="display: none;">
					</ul>
				</div>
				<input class="input-text detailed validate(maxlength(25))" placeholder="详细地址" id="detailAddr" type="text">
			</div>
			<div class="content_number clear">
				<div class="clear fl content_number_l">
					<div class="fl">经营许可证号：</div>
					<input class="input-text fl validate(maxlength(20))" id="permitNO" type="text">
				</div>
				<div class="clear fl content_number_l">
					<div class="fl">医疗器械注册证号：</div>
					<input class="input-text fl validate(maxlength(20))" id="registerNO" type="text">
				</div>
			</div>
			<div class="btn-group fr">
				<a class="btn fl " id="vendor_info_cancel">取消</a> <a onclick="addVendorAtInventory()" class="btn fl" wjperm="DICT06-SAVE">保存</a>
			</div>
		</div>
		<!-- end of .tab-content -->
	</div>
